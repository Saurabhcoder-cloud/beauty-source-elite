  ...
  return (
    <PageFrame>
      ...
      <section className="relative overflow-hidden pt-32 pb-24">
        ...
        <div className="relative mx-auto max-w-7xl px-6 grid gap-12 lg:grid-cols-[1.15fr_0.85fr] items-center">
          <div className="space-y-8">
            ...
            <p className="max-w-2xl text-lg text-muted-foreground leading-relaxed">
              Connect with our international sourcing desk for direct distributor pricing, export-ready logistics and priority support across retail, pharmacy and wholesale channels.
            </p>
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div key={item.label} className="glass rounded-3xl p-6 shadow-luxe border border-border">
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="glass rounded-3xl p-6 shadow-luxe absolute -bottom-16 right-0 max-w-sm animate-fade-up">
              <div className="text-xs uppercase tracking-[0.3em] text-muted-foreground">Priority line</div>
              <div className="mt-3 font-display text-3xl">Direct wholesale contact</div>
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                Reach our sales desk immediately with your order details and destination requirements.
              </p>
            </div>
          </div>
        </div>
