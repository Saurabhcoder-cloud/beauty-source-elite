...
const products: Product[] = [
  { t: "Vitamin C Brightening Serum", brand: "La Roche-Posay", img: "https://aakarfragrance.com/assets/img/portfolio/3.jpg", price: "Wholesale", size: "30ml", description: "Stabilized 10% pure vitamin C serum that visibly brightens and evens skin tone. Formulated with neurosensine to soothe sensitivity. Dermatologically tested, suitable for daily morning use." },
  { t: "Hyaluronic Daily Moisturizer", brand: "CeraVe", img: "https://aakarfragrance.com/assets/img/portfolio/3.jpg", price: "Wholesale", size: "473ml", description: "Lightweight, oil-free moisturizer with three essential ceramides and hyaluronic acid. Provides 24-hour hydration while restoring the skin barrier. Non-comedogenic, fragrance-free." },
  { t: "Mineral SPF50+ Sunscreen", brand: "Bioderma", img: "https://aakarfragrance.com/assets/img/portfolio/3.jpg", price: "Wholesale", size: "40ml", description: "Photostable broad-spectrum SPF50+ with 100% mineral filters. Tinted finish suitable for sensitive and intolerant skin. Reef-safe formulation." },
  { t: "Rose Eau de Parfum", brand: "Lancôme", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPE8fGO_s-UnhUeETzmbPu85q_WDvAslGdDg&s", price: "Wholesale", size: "100ml", description: "An elegant Damask rose composition with notes of bergamot, peony and white musk. Crafted in Grasse and aged for six months. Limited annual production." },
  ...
  { t: "Niacinamide 10% + Zinc 1%", brand: "The Ordinary", img: "https://aakarfragrance.com/assets/img/portfolio/3.jpg", price: "Wholesale", size: "30ml", description: "High-strength vitamin and mineral blemish formula. Reduces appearance of blemishes and congestion while balancing visible sebum activity." },
