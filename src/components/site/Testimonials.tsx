...
const reviews = [
  { name: "Aisha Khan", role: "Beauty Buyer · Glamour Stores", flag: "🇦🇪", country: "UAE", text: "We replaced two suppliers with Maison Beauté. Authenticity, paperwork and timing are all flawless." },
